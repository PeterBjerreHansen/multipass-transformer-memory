...
2. The recurrent/attention hybrid might be a "best of both worlds" type of model, but we really should compare with a purely attention-based model that has both long- and short-range attention.
