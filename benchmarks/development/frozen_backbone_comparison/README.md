...
On the target CUDA host, validate all three complete forward/backward paths
...
The resulting `results/training_flops.json` is derived directly from the three
