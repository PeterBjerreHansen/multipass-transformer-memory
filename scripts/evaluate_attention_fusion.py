...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Report raw Memory Attention signals, contribution RMS, and gate "
            "distributions at each reader site and feedback pass."
        )
    )
    ...
    document = {
        "schema_version": 1,
        "evaluation_kind": "memory_attention_fusion_signals",
